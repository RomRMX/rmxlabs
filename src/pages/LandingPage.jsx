...
const LandingPage = () => {
    ...
    return (
        <div className="bg-black min-h-screen w-full text-white font-sans selection:bg-purple-500 selection:text-white overflow-x-hidden relative flex flex-col">
            ...
            {/* Title Section */}
            <div className="relative z-10 pt-32 md:pt-[300px] pb-4 px-8 flex-shrink-0">
                <h1 className="text-[16.8vw] md:text-[11.2vw] font-[700] text-transparent bg-clip-text bg-[linear-gradient(to_bottom,#ffffff_0%,#ffffff_50%,rgba(255,255,255,0.5)_80%,transparent_100%)] tracking-[-0.05em] select-none mix-blend-difference text-center leading-none" style={{ fontFamily: 'Tomorrow, sans-serif' }}>
                    RMXLABS
                </h1>
            </div>
